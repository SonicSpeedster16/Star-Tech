...
<thermalfoundation:material:16>.addTooltip(format.yellow("Can be burned in a furnace as fuel"));
<thermalfoundation:material:832>.addTooltip(format.yellow("Can be burned in a furnace as fuel"));
